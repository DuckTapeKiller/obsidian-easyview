...
**Easy View** is a powerful status bar utility for Obsidian that provides instant control over your reading and writing environment. Adjust font sizes, toggle themes, switch between focus modes, cycle through font and color presets, and manage your layout—all from the status bar or via keyboard shortcuts.
...
| **Cycle Color Preset** | `🎨` | Cycles through your custom color presets |
...
Easy View includes a powerful preset system designed specifically for the **Brutalist theme**. You can define up to **3 font presets** and **3 color presets**, each with a custom name.
...
Each color preset includes four color settings:
...
| Cycle Color Preset | Advance to next color preset |
...
| Select Color Preset 1/2/3 | Jump directly to a specific color preset |
...
When you change fonts or colors using Easy View:
...
- **Persistence**: Your font and color selections survive Obsidian restarts
...
For each of the 3 color presets:
...
- **Recommended**: [Brutalist Theme](https://github.com/DuckTapeKiller/Brutalist) for Font/Color preset features
